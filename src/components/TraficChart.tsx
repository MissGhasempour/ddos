  ...
  return (
    <div className="border border-zinc-400 p-4 pt-7" id="outer">
      <div className="flex">
        ...
        <div className="flex relative left-80 rounded">
        ...
        <div className="relative left-85 border rounded mb-2 p-2 w-60 ">
          ...
          <svg
            ...
            className="absolute left-53 bottom-5 text-xl "
          >
            <path
              d="M1 1L5 5L9 1"
              stroke="white"
      ...
      <div className="relative left-164 p-2 border rounded bg-slate-700 w-60">
